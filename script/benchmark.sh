...
echo "Moby Dick"
hyperfine --warmup 100  -N --export-json "$benchmark_folder"/moby_dick.json 'wc benchmark_texts/moby_dick.txt' './target/release/ryan_wc benchmark_texts/moby_dick.txt naive'

echo "KJV 1x"
hyperfine --warmup 10  -N --export-json "$benchmark_folder"/kjv_1x.json 'wc benchmark_texts/kjv_1x.txt' './target/release/ryan_wc benchmark_texts/kjv_1x.txt naive'
